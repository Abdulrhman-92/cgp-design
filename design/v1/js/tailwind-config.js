/**
 * CGP Tailwind CDN config — inline version of wp-content/themes/cgp/tailwind.config.js.
 * Values are EXACT copies of the token table. Single source: assets/css/tokens.css.
 *
 * Usage: load the Tailwind Play CDN script first, then this file assigns the
 * global `tailwind.config` object. `content` is omitted — the CDN scans the DOM.
 *
 * NOTE: the compiled theme build (assets/css/tailwind.css) is the primary
 * stylesheet in index.html; this file is the fallback for CDN-based iteration.
 */
